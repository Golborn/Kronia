...
public class TestAndroidA005 {
	...
	public TestAndroidA005() {
		this.log = LogManager.getLogger(TestAndroidA005.class);
	...
	@Test
	public void testA005() throws Exception {
		// Parámetros
...
//		String password = "5946";
		...
		tap(By.xpath("//android.widget.TextView[contains(@text,'Estado de Cuenta')]"));
		Thread.sleep(7000);
	}
