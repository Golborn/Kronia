...
public class test004 {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    ScreenShot.captureScreen(ruta+"test4-1.png");
	    driver.findElement(By.id("entrar")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test4-2.png");
	    driver.findElement(By.cssSelector("span.icon.icon-menu")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test4-3.png");
	    driver.findElement(By.linkText("Mis Bolsas")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test4-4.png");
	    driver.findElement(By.linkText("Contratar bolsas")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test4-5.png");
	    driver.findElement(By.linkText("Bolsas de Voz")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test4-6.png");
	   /* driver.findElement(By.cssSelector("b")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test4-7.png");*/
	    Thread.sleep(5000);
	    driver.close();
