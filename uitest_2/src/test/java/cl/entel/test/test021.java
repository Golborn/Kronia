...
public class test021 {
	public static void main(String[] args) throws Exception {
	    ...
	    ScreenShot.captureScreen(ruta+"test21-1.png");
	    driver.findElement(By.id("entrar")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test21-2.png");
	    driver.findElement(By.cssSelector("span.icon.icon-menu")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test21-3.png");
	    new Select(driver.findElement(By.id("selectorCuentas"))).selectByVisibleText("+56 9 7766 1817");
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test21-4.png");
	    driver.findElement(By.cssSelector("span.icon.icon-menu")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test21-5.png");
	    driver.findElement(By.linkText("Recargas")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test21-6.png");
	    ...
	    Thread.sleep(3000);
	    ScreenShot.captureScreen(ruta+"test21-7.png");
	    driver.findElement(By.id("monto")).click();
	    Thread.sleep(3000);
	    ScreenShot.captureScreen(ruta+"test21-8.png");
	    new Select(driver.findElement(By.id("monto"))).selectByVisibleText("$500");
	    Thread.sleep(3000);
	    ScreenShot.captureScreen(ruta+"test21-9.png");
	    driver.findElement(By.cssSelector("option[value=\"00500\"]")).click();
	    Thread.sleep(3000);
	    ScreenShot.captureScreen(ruta+"test21-10.png");
	    driver.findElement(By.id("btn_continuar")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test21-11.png");
	    Thread.sleep(10000);
	    driver.close();
