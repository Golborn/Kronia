...
public class Personas_Web_Mobile05 {
...
WebDriver driver;
	...
	public void cal() throws Exception{
	    ...
	    FileUtils.copyFile(file, new File("test-5-05.jpg"));   
	    driver.findElement(By.linkText("Mis Bolsas")).click();
	    
	    
	    
	    
	    //ScreenShot.captureScreen("C:\\Users\\hp-pc\\Desktop\\Personas_Web_Mobile\\"+"hola.png");
	    JOptionPane.showMessageDialog(null,"Test realizado exitosamente"); 
	}
@Test
	public void testA() throws Exception {
		Personas_Web_Mobile05 a=new Personas_Web_Mobile05();
	a.setUp();
	a.cal();
