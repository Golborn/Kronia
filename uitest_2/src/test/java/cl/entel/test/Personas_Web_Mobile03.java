...
public class Personas_Web_Mobile03 {
	WebDriver driver;
	...
	public void cal() throws InterruptedException, IOException{
	    ...
	    driver.findElement(By.linkText("Ir a Estado de Cuenta")).click();
	    Thread.sleep(10000);
	    WebDriver driver1 = new Augmenter().augment(driver);
	    File file  = ((TakesScreenshot)driver1).getScreenshotAs(OutputType.FILE);
	    FileUtils.copyFile(file, new File("test-03-03.jpg")); 
	}
	
	@Test
	public void testA() throws Exception {
		Personas_Web_Mobile03 a=new Personas_Web_Mobile03();
	a.setUp();
	a.cal();           
	}
