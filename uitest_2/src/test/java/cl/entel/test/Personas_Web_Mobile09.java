...
public class Personas_Web_Mobile09 {
	WebDriver driver;
	...
	public void cal() throws InterruptedException, IOException{
		...
		final String FILE;
		String fono ="966293759"; 
		String rut ="16.106.032-1";
		String pin ="1694";
	    ...
	    FileUtils.copyFile(file, new File("test-9-03.jpg")); 
	    driver.close();
	}
@Test
	public void testA() throws Exception {
		Personas_Web_Mobile09 a=new Personas_Web_Mobile09();
	a.setUp();
	a.cal();           
	}
}
