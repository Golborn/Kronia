...
public class Personas_Web_Mobile06 {
	WebDriver driver;
	...
	public void cal() throws InterruptedException, IOException{
		...
		final String FILE;
		String fono ="991204276"; 
		String rut ="5.176.756-K";
		String pin ="8408";
	    ...
	    FileUtils.copyFile(file, new File("test-6-01.jpg")); 
	    driver.close();
	}
@Test
	public void testA() throws Exception {
		Personas_Web_Mobile06 a=new Personas_Web_Mobile06();
	a.setUp();
	a.cal();           
	}
