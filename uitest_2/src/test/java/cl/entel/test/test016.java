...
public class test016 {
	public static void main(String[] args) throws Exception {
	    ...
	    ScreenShot.captureScreen(ruta+"test16-1.png");
	    driver.findElement(By.id("entrar")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test16-2.png");
	    driver.findElement(By.cssSelector("span.icon.icon-menu")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test16-3.png");
	    driver.findElement(By.linkText("Consulta de saldo")).click();
	    Thread.sleep(5000);
	    ScreenShot.captureScreen(ruta+"test16-4.png");
	    driver.close();
