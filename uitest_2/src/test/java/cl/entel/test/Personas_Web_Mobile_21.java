...
public class Personas_Web_Mobile_21 {
	WebDriver driver;
	...
	public void cal(){
	    ...
	    new Select(driver.findElement(By.id("producto"))).selectByVisibleText("Telefonía Móvil");
	    ...
	    new Select(driver.findElement(By.id("monto"))).selectByVisibleText("$500");
	    driver.findElement(By.cssSelector("option[value=\"00500\"]")).click();
	    driver.findElement(By.id("btn_continuar")).click();
	}
	
	@Test
	public void testA() throws Exception {
		Personas_Web_Mobile_21 a=new Personas_Web_Mobile_21();
	a.setUp();
	a.cal();           
	}
}
